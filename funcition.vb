...
exits:
	...
	ff.Dispose
      ...
      public function adds(a as integer,b as integer)as integer
	return a+b
       end function	
      public function subs(a as integer,b as integer)as integer
	return a-b
       end function	
...
Public Class WinVBApp
   ...
   shared scr1 as new scr
	...
	b1.score(0)=int(rnd*999999)
	b1.score(1)=int(rnd*999999)
	b1.score(2)=b1.adds(b1.score(0),b1.score(1))
	b1.score(3)=b1.subs(b1.score(0),b1.score(1))
	b1.score(4)=b1.subs(b1.score(1),b1.score(0))
	b1.score(5)=b1.adds(b1.score(2),b1.adds(b1.score(0),b1.score(1)))
