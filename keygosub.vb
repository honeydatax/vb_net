...
'sample code
	...
	addcode ("        integer,var1,1")
	addcode ("        integer,var2,5")
	addcode ("        gosub,cmpthan")
	addcode ("                rem,change vars")
	addcode ("        add,var1,var2,var2")
	addcode ("        gosub,cmpthan")
	addcode ("        exit")	
	addcode ("label,lessthan")
	addcode ("        echo,var1 < var2")
	addcode ("        return")
	addcode ("label,gratherthan")
	addcode ("        echo,var1 > var2")
	addcode ("        return")
	addcode ("                rem,compere vars")
	addcode ("label,cmpthan")
	addcode ("        less,var1,var2,l0")
