...
'sample code
	...
	addcode ("        integer,b,0")
	addcode ("        integer,c,8")
	addcode ("        integer,fora,0")
	addcode ("        integer,into,10")
	addcode ("        integer,step,1")
	addcode ("        echo,make a table X of number")
	addcode ("        inputnumber,c")
	addcode ("        for,a,fora,into,step")
	addcode ("                printnumber,c")
	addcode ("                echo, X $")
	addcode ("                printnumber,a")
	addcode ("                mul,b,c,a")
	addcode ("                echo,=$")
