...
'sample code
	...
	addcode ("        set,a,hello world")
	addcode ("        integer,b,100")
	addcode ("        echo,befor")
	addcode ("        print,a")
	addcode ("        printnumber,b")
	addcode ("                rem,reset string")
	addcode ("        reset,a")
	addcode ("                rem,reset integer")
	addcode ("        reset,b")
	addcode ("                rem,end reseting")
	addcode ("        echo,")
	addcode ("        echo,afther")
	addcode ("        print,a")
	addcode ("        printnumber,b")
    ...
    Private Sub OnChange(ByVal sender As Object, ByVal e As EventArgs)
		dim line as integer =(text2.getlinefromcharindex(text2.selectionstart))+1
                 me.text="line -" +line.tostring
    end sub
