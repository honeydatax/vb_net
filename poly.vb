...
Imports System.Drawing.Drawing2D
   ...
   public class scales
	...
	dim points0 as new point(gscales.x+(gscales.w\2-gscales.min\2)+((gscales.min\8)*i),gscales.y)
	dim points1 as new point(gscales.x+(gscales.w\2-gscales.min\2)+((gscales.min\8)*(i+1)),gscales.y)
	...
	for i=0 to 7
	g.drawline(b,gscales.x+(gscales.w\2-gscales.min\2)+((gscales.min\8)*i),gscales.y,gscales.x+((gscales.w\8)*i),gscales.y+gscales.h)
        g.drawline(b,gscales.x,gscales.y+((gscales.h*(ii))\256),gscales.x+gscales.w,gscales.y+((gscales.h*(ii))\256))
	ii=ii\2
	next i
