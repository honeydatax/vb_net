...
exits:
	...
	for ssi = 0 to 23
		if bbox.ww(ssi).closed=0 then ss=ss+";"+str(ssi)+" box,"+str(bbox.ww(ssi).x\2)+","+str((bbox.ww(ssi).y*200)\350)+","+str(bbox.ww(ssi).w)+","+str((bbox.ww(ssi).h*480)\320) +chr(13)+chr(10)
